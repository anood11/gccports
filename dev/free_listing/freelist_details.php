...
include("freelist_details_action.php");
...
<div class="center">
	<h1 class="newsHead">Free List Company Details &raquo;</h1>
	...
	<h1 class="newsHead">Free List Branch Details &raquo;</h1>
	<table class="searchResult">
	  <tr>
		<th>Branch</th>
		<th>Address</th>
	...
	<h1 class="newsHead">Free List Category Details &raquo;</h1>
	<table class="searchResult">
		<tr>
		...
		<tr>
			<td><a href="<?php echo $httpPathSite;?>free_listing/view_freelist.php"><input type="button" name="btnBack" value="Back"/></a></td>
		</tr>
	</table>
</div>
<?php 
