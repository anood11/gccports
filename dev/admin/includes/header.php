...
<script src="<?php echo $http_path_admin;?>resources/scripts/jquery.ui.rcarousel.js" type="text/javascript"></script>
<script src="<?php echo $http_path_admin;?>resources/scripts/jquery.ui.widget.js" type="text/javascript"></script>
<script src="<?php echo $http_path_admin;?>resources/scripts/paging.js" type="text/javascript"></script>
<script src="<?php echo $http_path_admin;?>resources/scripts/basicScript.js" type="text/javascript"></script>
<script type="text/javascript">
var baseURLsite='<?php echo $http_path_site;?>';
var baseURLadmin='<?php echo $http_path_admin;?>';
</script>
</head>
<body>
<!-- TOP BLUE STRIP -->
...
<ul class="topNav">
	...
	<li><a href="<?php echo $http_path_admin;?>news/view_news.php">Manage News</a></li>
